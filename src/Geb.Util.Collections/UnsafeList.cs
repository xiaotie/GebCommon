...
namespace Geb.Util.Collections
{
    [DebuggerDisplay("Count = {Count}")]
    [Serializable]
    public class UnsafeList<T> : IList<T>, System.Collections.IList, IReadOnlyList<T>
    {
        ...
        public Span<T> ItemsSpan { get { return new Span<T>(_items, 0, _size); } }
        ...
        public UnsafeList<TOutput> ConvertAll<TOutput>(Converter<T, TOutput> converter)
        {
            ...
            UnsafeList<TOutput> list = new UnsafeList<TOutput>(_size);
            for (int i = 0; i < _size; i++)
            {
        ...
        void System.Collections.ICollection.CopyTo(Array array, int arrayIndex)
        {
            ...
            {
                ThrowHelper.ThrowArgumentException("Argument_InvalidArrayType");
            }
        }
        ...
        const int MaxArrayLength = 0x70000000;
        ...
        public int FindIndex(int startIndex, int count, Predicate<T> match)
        {
            ...
            {
                ThrowHelper.ThrowArgumentOutOfRangeException("startIndex");
            }
        ...
        public int IndexOf(T item, int index, int count)
        {
            ...
            if (count < 0 || index > _size - count) ThrowHelper.ThrowArgumentOutOfRangeException("count");
            Contract.Ensures(Contract.Result<int>() >= -1);
            Contract.Ensures(Contract.Result<int>() < Count);
            Contract.EndContractBlock();
        ...
        public struct Enumerator : IEnumerator<T>, System.Collections.IEnumerator
        {
            ...
            Object System.Collections.IEnumerator.Current
            {
                get
                {
                    ...
                    {
                        ThrowHelper.ThrowInvalidOperationException("InvalidOperation_EnumOpCantHappen");
                    }
                    return Current;
                }
            }
